...
class SaleOrder(models.Model):
    ...
    remaining_credit = fields.Monetary(related='partner_id.remaining_credit', currency_field='company_currency_id')
    ...
    def confirm_quotation_with_apj(self):
        ...
        if partner_id.credit_check != False:
            ...
            # elif partner_id.credit_warning <= total_amount and partner_id.credit_blocking > total_amount:
                ...
                if not self._context.get('warning'):
                    ...
                    res = super(SaleOrder, self).confirm_quotation_with_apj()
                    return res
                    # return {
                    #     'name': 'Warning',
                    #     'type': 'ir.actions.act_window',
