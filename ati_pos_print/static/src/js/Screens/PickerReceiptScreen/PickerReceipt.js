odoo.define('ati_pos_print.PickerReceipt', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class PickerReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    PickerReceipt.template = 'PickerReceipt';

    Registries.Component.add(PickerReceipt);

    return PickerReceipt;
});
