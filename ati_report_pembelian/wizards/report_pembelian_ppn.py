...
class report_pembelian_ppn(models.TransientModel):
    _name = 'report.pembelian.ppn'

    start_date = fields.Date("Start Date")
    end_date = fields.Date("End Date")

    def action_print_report_pembelian_ppn(self):
        data = {
            'ids': self.ids,
            'model': self._name,
            'form': {
        ...
        return self.env.ref('ati_report_pembelian.action_report_pembelian_ppn').report_action(self, data=data)

    def action_print_report_pembelian_ppn_xlsx(self):
        ...
        return self.env.ref('ati_report_pembelian.action_report_pembelian_ppn_xlsx').report_action(self, data=datas)

class po_ppn_template(models.AbstractModel):
    _name = 'report.ati_report_pembelian.po_ppn_template'
...
class po_ppn_template_xlsx(models.AbstractModel):
    _name = 'report.ati_report_pembelian.po_ppn_template_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objs):
        ...
        title = 'Laporan Rekap Pembelian PPN'
        ...
        sheet.merge_range(1, 0, 1, 3, 'Laporan Rekap Pembelian PPN', formatHeaderCompany)
